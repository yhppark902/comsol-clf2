...
model.param.set('phi1', '0[rad]');
model.param.set('phi1_t', '0[rad/s]');
model.param.set('phi2', '0[rad]');
model.param.set('phi2_t', '0[rad/s]');
...
model.component('comp1').physics('mbd').feature('rd1').feature('init1').set('phi', 'phi1');
model.component('comp1').physics('mbd').feature('rd1').feature('init1').set('phit', 'phi1_t');
model.component('comp1').physics('mbd').feature('rd2').set('InitialValueType', 'locallyDefined');
model.component('comp1').physics('mbd').feature('rd2').feature('init1').set('phi', 'phi2');
model.component('comp1').physics('mbd').feature('rd2').feature('init1').set('phit', 'phi2_t');
...
array_rd1_th=rd1_th;
rd1_th_t=[0];
array_rd1_th_t=rd1_th_t;

rd2_th=[phi2];
array_rd2_th=rd2_th;
rd2_th_t=[0];
array_rd2_th_t=rd2_th_t;

array_t_ode23=[];
array_rd1_th_ode23=[];
array_rd1_th_t_ode23=[];
...
array_rd1_th_t_ode23=[array_rd1_th_t_ode23;y(2,:)'];
array_rd2_th_ode23=[array_rd2_th_ode23;y(3,:)'];
array_rd2_th_t_ode23=[array_rd2_th_t_ode23;y(4,:)'];

t=mphglobal(model,'root.t')+t(end);
array_t=[array_t;t];

th1=mphglobal(model,'mbd.hgj1.th');
array_rd1_th=[array_rd1_th;th1];
phi1=array_rd1_th(end);
th_t1=mphglobal(model,'mbd.hgj1.th_t');
array_rd1_th_t=[array_rd1_th_t;th_t1];
phi1_t=array_rd1_th_t(end);

th2=mphglobal(model,'mbd.hgj2.th');
array_rd2_th=[array_rd2_th;th2];
phi2=array_rd2_th(end);
th_t2=mphglobal(model,'mbd.hgj2.th_t');
...
hold on
plot(array_t_ode23,array_rd1_th_t_ode23,'--')
legend('comsol','ode23s');
xlabel('time(s)');
ylabel('dtheta(rad/s)');
...
hold on
plot(array_t_ode23,array_rd2_th_t_ode23,'--')
legend('comsol','ode23s');
xlabel('time(s)');
ylabel('theta(rad/s)');